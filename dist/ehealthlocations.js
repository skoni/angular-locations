...
.constant('gn', [{depth:0,name:'région',plural:'régions',items:[{name:'conakry',id:'C'},{name:'boké',id:'B'},{name:'faranah',id:'F'},{name:'kankan',id:'K'},{name:'kindia',id:'D'},{name:'labé',id:'L'},{name:'mamou',id:'M'},{name:'n\'zérékoré',id:'N'}]},{depth:1,name:'préfecture',plural:'préfectures',items:[{id:'BE',name:'beyla',parentId:'N'},{id:'BF',name:'boffa',parentId:'B'},{id:'BK',name:'boké',parentId:'B'},{id:'CY',name:'conakry',parentId:'C'},{id:'CO',name:'coyah',parentId:'D'},{id:'DB',name:'dabola',parentId:'F'},{id:'DL',name:'dalaba',parentId:'M'},{id:'DI',name:'dinguiraye',parentId:'F'},{id:'DU',name:'dubréka',parentId:'D'},{id:'FA',name:'faranah',parentId:'F'},{id:'FO',name:'forécariah',parentId:'D'},{id:'FR',name:'fria',parentId:'B'},{id:'GA',name:'gaoual',parentId:'B'},{id:'GU',name:'guékédou',parentId:'N'},{id:'KA',name:'kankan',parentId:'K'},{id:'KE',name:'kérouané',parentId:'K'},{id:'KD',name:'kindia',parentId:'D'},{id:'KS',name:'kissidougou',parentId:'F'},{id:'KB',name:'koubia',parentId:'L'},{id:'KN',name:'koundara',parentId:'B'},{id:'KO',name:'kouroussa',parentId:'K'},{id:'LA',name:'labé',parentId:'L'},{id:'LE',name:'lélouma',parentId:'L'},{id:'LO',name:'lola',parentId:'N'},{id:'MC',name:'macenta',parentId:'N'},{id:'ML',name:'mali',parentId:'L'},{id:'MM',name:'mamou',parentId:'M'},{id:'MD',name:'mandiana',parentId:'K'},{id:'NZ',name:'nzérékoré',parentId:'N'},{id:'PI',name:'pita',parentId:'M'},{id:'SI',name:'siguiri',parentId:'K'},{id:'TE',name:'télimélé',parentId:'D'},{id:'TO',name:'tougué',parentId:'L'},{id:'YO',name:'yomou',parentId:'N'}]},{depth:2,name:'sous-préfecture',plural:'sous-préfectures',items:[{id:1,name:'albadaria',parentId:'KS'},{id:2,name:'alassoya',parentId:'FO'},{id:3,name:'arfamoussaya',parentId:'DB'},{id:4,name:'babila',parentId:'KO'},{id:5,name:'badi',parentId:'DU'},{id:6,name:'baguinet',parentId:'TE'},{id:7,name:'balaki',parentId:'ML'},{id:8,name:'balandougou',parentId:'KA'},{id:9,name:'balandougouba',parentId:'MD'},{id:10,name:'balato',parentId:'KO'},{id:11,name:'balaya',parentId:'LE'},{id:12,name:'balizia',parentId:'LO'},{id:13,name:'banama',parentId:'KS'},{id:14,name:'banankoro',parentId:'KE'},{id:15,name:'banfélé',parentId:'KO'},{id:16,name:'bangouyah',parentId:'FR'},{id:17,name:'banguingny',parentId:'TE'},{id:18,name:'banian',parentId:'FA'},{id:19,name:'banié',parentId:'NZ'},{id:20,name:'banko',parentId:'DB'},{id:21,name:'bankon',parentId:'SI'},{id:22,name:'banora',parentId:'DI'},{id:23,name:'bantignel',parentId:'PI'},{id:24,name:'bardou',parentId:'KS'},{id:25,name:'baro',parentId:'KO'},{id:26,name:'bate-nafadji',parentId:'KA'},{id:27,name:'beindou, faranah',parentId:'FA'},{id:28,name:'beindou, kissidougou',parentId:'KS'},{id:29,name:'benty',parentId:'FO'},{id:30,name:'beyla-centre',parentId:'BE'},{id:31,name:'bheeta',parentId:'NZ'},{id:32,name:'bignamou',parentId:'NZ'},{id:33,name:'binikala',parentId:'LO'},{id:34,name:'bintimodiya',parentId:'BK'},{id:35,name:'bissikrima',parentId:'DB'},{id:36,name:'bodié',parentId:'DL'},{id:37,name:'boffa-centre',parentId:'BF'},{id:38,name:'bofossou',parentId:'LO'},{id:39,name:'boké-centre',parentId:'BK'},{id:40,name:'bolodou',parentId:'YO'},{id:41,name:'boola',parentId:'BE'},{id:42,name:'bossou',parentId:'GU'},{id:43,name:'boula',parentId:'KA'},{id:44,name:'bouliwel',parentId:'MM'},{id:45,name:'bounouma',parentId:'NZ'},{id:46,name:'bourouwal',parentId:'KD'},{id:47,name:'bowé',parentId:'NZ'},{id:48,name:'bourouwal-tappé',parentId:'PI'},{id:49,name:'cisséla',parentId:'KO'},{id:50,name:'coyah-centre',parentId:'CO'},{id:51,name:'dabiss',parentId:'BK'},{id:52,name:'dabola-centre',parentId:'DB'},{id:53,name:'dalaba-centre',parentId:'DL'},{id:54,name:'dalein',parentId:'LA'},{id:55,name:'damankanyah',parentId:'FR'},{id:56,name:'damaro',parentId:'KE'},{id:57,name:'daralabe',parentId:'LA'},{id:58,name:'daramagnaky',parentId:'KD'},{id:59,name:'daro',parentId:'LO'},{id:60,name:'dialakoro, faranah',parentId:'DI'},{id:61,name:'dialakoro, kankan',parentId:'MD'},{id:62,name:'diara-guerela',parentId:'BE'},{id:63,name:'diari',parentId:'LA'},{id:64,name:'diassodou',parentId:'BE'},{id:65,name:'diatiféré',parentId:'DI'},{id:66,name:'diécké',parentId:'NZ'},{id:67,name:'dinguiraye-centre',parentId:'DI'},{id:68,name:'dionfo',parentId:'LA'},{id:69,name:'diountou',parentId:'LE'},{id:70,name:'ditinn',parentId:'DL'},{id:71,name:'dixinn',parentId:'CY'},{id:72,name:'dogomet',parentId:'DB'},{id:73,name:'doko',parentId:'SI'},{id:74,name:'donghol-sigon',parentId:'ML'},{id:75,name:'dongol-touma',parentId:'PI'},{id:76,name:'douako',parentId:'KO'},{id:77,name:'dougountouny',parentId:'ML'},{id:78,name:'dounet',parentId:'MM'},{id:79,name:'douprou',parentId:'BF'},{id:80,name:'doura',parentId:'KO'},{id:81,name:'dubréka-centre',parentId:'DU'},{id:82,name:'fafaya',parentId:'KB'},{id:83,name:'falessade',parentId:'DU'},{id:84,name:'fangamadou',parentId:'YO'},{id:85,name:'faralako',parentId:'MD'},{id:86,name:'faranah-centre',parentId:'FA'},{id:87,name:'farmoriah',parentId:'FO'},{id:88,name:'fassankoni',parentId:'LO'},{id:89,name:'fatako',parentId:'TO'},{id:90,name:'fello-koundoua',parentId:'TO'},{id:91,name:'fermessadou-pombo',parentId:'KS'},{id:92,name:'firawa',parentId:'KS'},{id:93,name:'forécariah-centre',parentId:'FO'},{id:94,name:'fouala',parentId:'BE'},{id:95,name:'fougou',parentId:'ML'},{id:96,name:'foulamory',parentId:'GA'},{id:97,name:'foumbadou',parentId:'GU'},{id:98,name:'franwalia',parentId:'SI'},{id:99,name:'fria-centre',parentId:'TE'},{id:100,name:'friguiagbé',parentId:'FR'},{id:101,name:'gadha-woundou',parentId:'KB'},{id:102,name:'gagnakali',parentId:'DI'},{id:103,name:'gama berema',parentId:'GU'},{id:104,name:'gaoual-centre',parentId:'GA'},{id:105,name:'garambé',parentId:'LA'},{id:106,name:'gayah',parentId:'ML'},{id:107,name:'gbakedou',parentId:'BE'},{id:108,name:'gbangbadou',parentId:'KS'},{id:109,name:'gbérédou-baranama',parentId:'KA'},{id:110,name:'gbessoba',parentId:'BE'},{id:111,name:'gnaléah',parentId:'FA'},{id:112,name:'gongore',parentId:'PI'},{id:113,name:'gongoret',parentId:'MM'},{id:114,name:'gouécké',parentId:'NZ'},{id:115,name:'gougoudjé',parentId:'KD'},{id:116,name:'guendembou',parentId:'GU'},{id:117,name:'guéassou',parentId:'YO'},{id:118,name:'guéckédou-centre',parentId:'YO'},{id:119,name:'guingan',parentId:'KN'},{id:120,name:'hafia',parentId:'LA'},{id:121,name:'hérémakonon',parentId:'FA'},{id:122,name:'hérico',parentId:'LE'},{id:123,name:'hidayatou',parentId:'ML'},{id:124,name:'kaala',parentId:'DL'},{id:125,name:'kaalan',parentId:'LA'},{id:126,name:'kaback',parentId:'FO'},{id:127,name:'kakony',parentId:'GA'},{id:128,name:'kakossa',parentId:'FO'},{id:129,name:'kalinko',parentId:'FO'},{id:130,name:'kallia',parentId:'DI'},{id:131,name:'kaloum',parentId:'CY'},{id:132,name:'kamaby',parentId:'KN'},{id:133,name:'kamsar',parentId:'BK'},{id:134,name:'kanfarandé',parentId:'BK'},{id:135,name:'kankalabé',parentId:'DL'},{id:136,name:'kankama',parentId:'DB'},{id:137,name:'kankan-centre',parentId:'KA'},{id:138,name:'kansangui',parentId:'TO'},{id:139,name:'kantoumania',parentId:'MD'},{id:140,name:'karala',parentId:'BE'},{id:141,name:'kanfamoriyah',parentId:'KA'},{id:142,name:'kassadou',parentId:'YO'},{id:143,name:'kébali',parentId:'DL'},{id:144,name:'kégnéko',parentId:'MM'},{id:145,name:'kérouané-centre',parentId:'KE'},{id:146,name:'khorira',parentId:'DU'},{id:147,name:'kindia-centre',parentId:'FR'},{id:148,name:'kindoyé',parentId:'DB'},{id:149,name:'kiniébakoura',parentId:'SI'},{id:150,name:'kiniéran',parentId:'MD'},{id:151,name:'kiniéro',parentId:'KO'},{id:152,name:'kintinian',parentId:'SI'},{id:153,name:'kissidougou-centre',parentId:'KS'},{id:154,name:'koba, faranah',parentId:'DL'},{id:155,name:'koba, kindia',parentId:'KD'},{id:156,name:'koba-tatema',parentId:'BF'},{id:157,name:'kobéla',parentId:'NZ'},{id:158,name:'kobikoro',parentId:'FA'},{id:159,name:'koïn',parentId:'TO'},{id:160,name:'kokota',parentId:'GU'},{id:161,name:'kolaboui',parentId:'BK'},{id:162,name:'kolangui',parentId:'TO'},{id:163,name:'kolenté',parentId:'FR'},{id:164,name:'kollet, labé',parentId:'TO'},{id:165,name:'kolia',parentId:'BF'},{id:166,name:'kollet, télimélé',parentId:'KD'},{id:167,name:'komodou',parentId:'KE'},{id:168,name:'komola-koura',parentId:'KO'},{id:169,name:'konah',parentId:'TO'},{id:170,name:'kondiadou',parentId:'KS'},{id:171,name:'konindou',parentId:'DB'},{id:172,name:'konkouré',parentId:'KE'},{id:173,name:'konsotamy',parentId:'KD'},{id:174,name:'korbé',parentId:'LE'},{id:175,name:'koropara',parentId:'NZ'},{id:176,name:'kouankan',parentId:'LO'},{id:177,name:'koubia-centre',parentId:'KB'},{id:178,name:'koulé',parentId:'NZ'},{id:179,name:'koumana',parentId:'KO'},{id:180,name:'koumandou',parentId:'BE'},{id:181,name:'koumban',parentId:'KA'},{id:182,name:'koumbia',parentId:'GA'},{id:183,name:'koundara-centre',parentId:'KN'},{id:184,name:'koundian',parentId:'MD'},{id:185,name:'koundianakoro',parentId:'MD'},{id:186,name:'koundou',parentId:'YO'},{id:187,name:'kounsankoro',parentId:'MM'},{id:188,name:'kounsitel',parentId:'GA'},{id:189,name:'kouramangui',parentId:'LA'},{id:190,name:'kouratongo',parentId:'TO'},{id:191,name:'kouriah',parentId:'CO'},{id:192,name:'kouroussa-centre',parentId:'KO'},{id:193,name:'koyamah',parentId:'LO'},{id:194,name:'labé-centre',parentId:'LA'},{id:195,name:'lafou',parentId:'LE'},{id:196,name:'lain',parentId:'GU'},{id:197,name:'lansanya',parentId:'DI'},{id:198,name:'lébékére',parentId:'ML'},{id:199,name:'lélouma-centre',parentId:'LE'},{id:200,name:'ley-miro',parentId:'PI'},{id:201,name:'linko',parentId:'KE'},{id:202,name:'linsan saran',parentId:'LE'},{id:203,name:'lisso',parentId:'BF'},{id:204,name:'lola-centre',parentId:'GU'},{id:205,name:'macenta-centre',parentId:'LO'},{id:206,name:'maci',parentId:'PI'},{id:207,name:'madina-oula',parentId:'FR'},{id:208,name:'madina-wora',parentId:'ML'},{id:209,name:'mafara',parentId:'DL'},{id:210,name:'maférinya',parentId:'FO'},{id:211,name:'malanta',parentId:'GA'},{id:212,name:'malapouyah',parentId:'BK'},{id:213,name:'maléa',parentId:'SI'},{id:214,name:'mali-centre',parentId:'ML'},{id:215,name:'mambia',parentId:'FR'},{id:216,name:'mamou-centre',parentId:'MM'},{id:217,name:'mamouroudou',parentId:'KA'},{id:218,name:'manda',parentId:'LE'},{id:219,name:'mandiana-centre',parentId:'MD'},{id:220,name:'manéah',parentId:'CO'},{id:221,name:'manfran',parentId:'KS'},{id:222,name:'mankountan',parentId:'BF'},{id:223,name:'marela',parentId:'FA'},{id:224,name:'matakaou',parentId:'KB'},{id:225,name:'matam',parentId:'CY'},{id:226,name:'matoto',parentId:'CY'},{id:227,name:'missamana',parentId:'KA'},{id:228,name:'missira, kindia',parentId:'KB'},{id:229,name:'missira, labé',parentId:'KD'},{id:230,name:'mitty',parentId:'DL'},{id:231,name:'molota',parentId:'FR'},{id:232,name:'mombéyah',parentId:'DL'},{id:233,name:'moribayah',parentId:'KA'},{id:234,name:'morodou',parentId:'MD'},{id:235,name:'moussadou',parentId:'BE'},{id:236,name:'moussaya',parentId:'FO'},{id:237,name:'naboun',parentId:'SI'},{id:238,name:'n\'déma',parentId:'DB'},{id:239,name:'niagassola',parentId:'SI'},{id:240,name:'niandankoro',parentId:'SI'},{id:241,name:'niantania',parentId:'MD'},{id:242,name:'ninguélandé',parentId:'PI'},{id:243,name:'nionsomoridou',parentId:'BE'},{id:244,name:'nongoa',parentId:'YO'},{id:245,name:'norassoba',parentId:'SI'},{id:246,name:'noussy',parentId:'LA'},{id:247,name:'nyagara',parentId:'MM'},{id:248,name:'n\'zébéla',parentId:'LO'},{id:249,name:'n\'zérékoré-centre',parentId:'NZ'},{id:250,name:'n\'zoo',parentId:'GU'},{id:251,name:'ouassou',parentId:'DU'},{id:252,name:'ouéndé-kénéma',parentId:'YO'},{id:253,name:'ouré-kaba',parentId:'MM'},{id:254,name:'ourémaï',parentId:'LO'},{id:255,name:'palé',parentId:'NZ'},{id:256,name:'panziazou',parentId:'LO'},{id:257,name:'parawol',parentId:'LE'},{id:258,name:'passayah',parentId:'FA'},{id:259,name:'péla',parentId:'NZ'},{id:260,name:'pilimini',parentId:'KB'},{id:261,name:'pita-centre',parentId:'PI'},{id:262,name:'popodara',parentId:'LA'},{id:263,name:'porédaka',parentId:'MM'},{id:264,name:'ratoma',parentId:'CY'},{id:265,name:'sabadou-baranama',parentId:'KA'},{id:266,name:'sagalé',parentId:'LE'},{id:267,name:'sokourala',parentId:'BE'},{id:268,name:'saladou',parentId:'MD'},{id:269,name:'salambandé',parentId:'ML'},{id:270,name:'samana',parentId:'BE'},{id:271,name:'samayah',parentId:'FR'},{id:272,name:'sambailo',parentId:'KN'},{id:273,name:'samoé',parentId:'NZ'},{id:274,name:'sandéniah',parentId:'FA'},{id:275,name:'sangardo',parentId:'KS'},{id:276,name:'sangaréah',parentId:'PI'},{id:277,name:'sangarédi',parentId:'BK'},{id:278,name:'sanguiana',parentId:'KO'},{id:279,name:'sannou',parentId:'LA'},{id:280,name:'sansalé',parentId:'BK'},{id:281,name:'sansando',parentId:'MD'},{id:282,name:'santou',parentId:'KD'},{id:283,name:'saramoussaya',parentId:'MM'},{id:284,name:'saréboido',parentId:'KN'},{id:285,name:'sarékaly',parentId:'KD'},{id:286,name:'sengbédou',parentId:'DI'},{id:287,name:'sélouma',parentId:'LO'},{id:288,name:'sérédou',parentId:'LO'},{id:289,name:'sibiribaro',parentId:'KE'},{id:290,name:'siguiri-centre',parentId:'SI'},{id:291,name:'siguirini',parentId:'SI'},{id:292,name:'sikhourou',parentId:'FO'},{id:293,name:'sinko',parentId:'BE'},{id:294,name:'sinta',parentId:'KD'},{id:295,name:'sintali',parentId:'PI'},{id:296,name:'sogolon',parentId:'KD'},{id:297,name:'songoyah',parentId:'FA'},{id:298,name:'soromaya',parentId:'KE'},{id:299,name:'souguéta',parentId:'FR'},{id:300,name:'soulouta',parentId:'NZ'},{id:301,name:'soyah',parentId:'MM'},{id:302,name:'tamita',parentId:'BF'},{id:303,name:'tanéné, boké',parentId:'DU'},{id:304,name:'tanéné, dubréka',parentId:'BK'},{id:305,name:'tangali',parentId:'TO'},{id:306,name:'tarihoye',parentId:'KD'},{id:307,name:'téguéréya',parentId:'MM'},{id:308,name:'tekoulo',parentId:'YO'},{id:309,name:'télimélé-centre',parentId:'KD'},{id:310,name:'téliré',parentId:'ML'},{id:311,name:'termessadou-dibo',parentId:'YO'},{id:312,name:'termesse',parentId:'KN'},{id:313,name:'thionthian',parentId:'KD'},{id:314,name:'tyanguel-bori',parentId:'LE'},{id:315,name:'timbi-madina',parentId:'PI'},{id:316,name:'timbi-touny',parentId:'PI'},{id:317,name:'timbo',parentId:'MM'},{id:318,name:'tinti-oulen',parentId:'KA'},{id:319,name:'tiro',parentId:'FA'},{id:320,name:'tokounou',parentId:'KA'},{id:321,name:'tolo',parentId:'MM'},{id:322,name:'tondon',parentId:'DU'},{id:323,name:'tormelin',parentId:'TE'},{id:324,name:'touba, boké',parentId:'GA'},{id:325,name:'touba, labé',parentId:'ML'},{id:326,name:'tougnifili',parentId:'BF'},{id:327,name:'tougué-centre',parentId:'TO'},{id:328,name:'tounkarata',parentId:'GU'},{id:329,name:'tountouroun',parentId:'LA'},{id:330,name:'vassérédou',parentId:'LO'},{id:331,name:'watanka',parentId:'LO'},{id:332,name:'wendou m\'bour',parentId:'GA'},{id:333,name:'womey',parentId:'NZ'},{id:334,name:'wonkifong',parentId:'CO'},{id:335,name:'yalenzou',parentId:'NZ'},{id:336,name:'yendé-millimou',parentId:'KS'},{id:337,name:'yimbéring',parentId:'ML'},{id:338,name:'yombiro',parentId:'KS'},{id:339,name:'yomou-centre',parentId:'NZ'},{id:340,name:'youkounkoun',parentId:'KN'}]}])
